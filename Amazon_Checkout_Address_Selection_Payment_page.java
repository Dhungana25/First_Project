...
public class Amazon_Checkout_Address_Selection_Payment_page {
	...
	@FindBy(xpath="(//span[@class='a-declarative'])[11]")
	...
	/*@FindBy(xpath="(//span[@class='a-size-small a-color-tertiary'])[1]")
	WebElement adddebit_creditcard;
	
	@FindBy(xpath="//button[@id='pp-KUZ6BE-32-announce']")
 ...
 /* public void adding_carddetails() {
  ...
  public void cancel() {
	...
	public Amazon_Checkout_Address_Selection_Payment_page(WebDriver driver)
